...
const LinksAndJobs = ({ git, facebook, jobsAndUsers, sendOffer, user_token, owner, offers, showOffer }) =>
  <Wrapper>
    <Links>
      <Label>
        Links
    ...
    <Jobs>
      ...
      <JobsContent>
        {
          jobsAndUsers.map(({ _id: offerId ,userId, jobId: { _id, name }}, index) => !userId &&
